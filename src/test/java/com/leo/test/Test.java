...
public class Test {
    ...
    public  void test() throws InterruptedException {
        ...
        for (int i = 0; i < 200; i++) {
            ...
            log.info("Travel times : "+i+1+" , Position of vehicle before driving : x" + car.getPositionX() + " , y = "+car.getPositionY()+ " ,The direction of the car is : " + car.getOrientation().toString());
            try {
                car.move(car, car.getOrientation());
                log.info("Travel times : "+i+1+" ,Position of car after driving : x = " + car.getPositionX() + " , y = "+car.getPositionY()+ " ,The direction of the car is : " + car.getOrientation().toString());
